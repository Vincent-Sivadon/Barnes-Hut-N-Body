_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 1.2987,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1.0968,
    profiled_time = 0.8,
    array_access_efficiency = 78.407890102149,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.1861,
    nb_threads = 1,
    application_time = 0.8,
    compilation_options = "Not Available",
    innerloops_time = 28.39,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 0.22712 seconds.",
    ...
    profiled_time = "Application profiling duration in seconds<br><b>Too short run</b>: profiling results are not statistically significant (profiled time corresponds to 155 samples) and should not be used<br><b>Workaround</b>: Rerun with a longer workload and/or use sampling-rate=high/highest in lprof_params",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 0.22712 seconds.",
  },
  colors = {
